...
public class EnemyLookController : MonoBehaviour
{
    ...
    void Start()
    {
        target = FindAnyObjectByType<TopDownCharacterController>().transform;
    ...
    private void HandleMouseInput()
    {
        ...
        // worldMousePosition = target.ScreenToWorldPoint(new Vector3(mousePosition.x, mousePosition.y, targetCamera.nearClipPlane));
        ...
        worldMousePosition = target.position;
    }
